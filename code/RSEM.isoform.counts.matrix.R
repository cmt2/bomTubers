...
source("/Users/carrietribble/Desktop/trans_diff/trinityrnaseq-Trinity-v2.8.4/Analysis/DifferentialExpression/R/heatmap.3.R")
source("/Users/carrietribble/Desktop/trans_diff/trinityrnaseq-Trinity-v2.8.4/Analysis/DifferentialExpression/R/misc_rnaseq_funcs.R")
source("/Users/carrietribble/Desktop/trans_diff/trinityrnaseq-Trinity-v2.8.4/Analysis/DifferentialExpression/R/pairs3.R")
source("/Users/carrietribble/Desktop/trans_diff/trinityrnaseq-Trinity-v2.8.4/Analysis/DifferentialExpression/R/vioplot2.R")
data = primary_data
...
write.table(data, file="RSEM.isoform.counts.matrix.minRow10.log2.dat", quote=F, sep='	');
gene_cor = NULL
